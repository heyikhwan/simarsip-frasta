...
@section('container')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createModal">Tambah Data Penerima Surat</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nama_penerima_surat" class="form-control"
    ...
    @foreach ($receiver as $item)
        @php
            $id = $item->id_penerima_surat;
            $name = $item->nama_penerima_surat;
        @endphp
        <div class="modal fade" id="updateModal{{ $id }}" role="dialog" aria-labelledby="createModal"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('penerima.update', $item->id_penerima_surat) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="mb-3">
    ...
    <script>
        var datatable = $('#crudTable').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'nama_penerima_surat',
                    name: 'nama_penerima_surat'
                },
                {
                    data: 'action',
                    name: 'action',
