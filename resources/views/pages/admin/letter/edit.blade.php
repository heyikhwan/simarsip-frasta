...
<main>
    ...
    <div class="container-fluid px-4">
        ...
        @endif
        <form action="{{ route('letter.update', $item->id_arsip_surat) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row gx-4">
                <div class="col-lg-9">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="tipe_surat" class="form-control" id="tipe_surat" required>
                                        <option value="">Pilih..</option>
                                        <option value="Surat Masuk" {{ $item->tipe_surat == 'Surat Masuk' ? 'selected' :
                                            '' }}>Surat Masuk
                                        </option>
                                        <option value="Surat Keluar" {{ $item->tipe_surat == 'Surat Keluar' ? 'selected'
                                            : '' }}>Surat Keluar
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="mb-3 row">
                                <label for="kode_surat" class="col-sm-3 col-form-label">No. Surat</label>
                                <div class="col-sm-9">
                                    <input type="text" id="kode_surat"
                                        class="form-control @error('kode_surat') is-invalid @enderror"
                                        value="{{ $item->kode_surat }}" name="kode_surat" placeholder="Nomor Surat.."
                                        required readonly>
                                </div>
                                @error('kode_surat')
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control @error('tanggal_surat') is-invalid @enderror"
                                        value="{{ $item->tanggal_surat }}" name="tanggal_surat" required>
                                </div>
                                @error('tanggal_surat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date"
                                        ...
                                        value="{{ $item->tanggal_diterima }}" name="tanggal_diterima" required>
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('perihal') is-invalid @enderror"
                                        value="{{ $item->perihal }}" name="perihal" placeholder="Perihal.." required>
                                </div>
                                @error('perihal')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="mb-3 row" id="divsender">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_pengirim_surat" class="form-control selectx">
                                        ...
                                        <option value="{{ $sender->id_pengirim_surat }}" {{ $item->id_pengirim_surat ==
                                            $sender->id_pengirim_surat ? 'selected' : '' }}>
                            ...
                            <div class="mb-3 row" id="divreceiver">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_penerima_surat" class="form-control selectx">
                                        ...
                                        <option value="{{ $receiver->id_penerima_surat }}" {{ $item->id_penerima_surat
                                            == $receiver->id_penerima_surat ? 'selected' : '' }}>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file"
                                        ...
                                        value="{{ old('file_arsip_surat') }}" name="file_arsip_surat" accept=".pdf">
                                    <div id="file_arsip_surat" class="form-text">Ekstensi .pdf | Kosongkan file jika
                                        tidak
                                        diisi</div>
                                </div>
