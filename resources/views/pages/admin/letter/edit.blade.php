                                    ...
                                    <div class="col-sm-9">
                                        <select name="tipe_surat" class="form-control" id="tipe_surat" required>
                                            ...
                                            <option value="Surat Masuk"
                                                {{ $item->tipe_surat == 'Surat Masuk' ? 'selected' : '' }}>Surat Masuk
                                            </option>
                                            <option value="Surat Keluar"
                                                {{ $item->tipe_surat == 'Surat Keluar' ? 'selected' : '' }}>Surat Keluar
                                            </option>
                                        </select>
                                    </div>
                                    @error('tipe_surat')
                                        ...
                                        <select name="id_pengirim_surat" class="form-control selectx">
                                            ...
                                            @foreach ($senders as $sender)
                                                <option value="{{ $sender->id_pengirim_surat }}"
                                                    {{ $item->id_pengirim_surat == $sender->id_pengirim_surat ? 'selected' : '' }}>
                                        ...
                                        <select name="id_penerima_surat" class="form-control selectx">
                                            ...
                                            @foreach ($receivers as $receiver)
                                                <option value="{{ $receiver->id_penerima_surat }}"
                                                    {{ $item->id_penerima_surat == $receiver->id_penerima_surat ? 'selected' : '' }}>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file"
                                            ...
                                            value="{{ old('file_arsip_surat') }}" name="file_arsip_surat">
